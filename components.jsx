  ...
  <FadeSection id="about" className="section section-paper" style={{ padding: '120px 32px' }}>
    <div style={{ maxWidth: '640px', margin: '0 auto' }}>
      ...
      <p className="body-text" style={{ marginBottom: '24px' }}>
        I'm a Senior PM based in Toronto. I've been building AI-powered products since{' '}
        <Annotation type="underline" text="early days" seed={3}>2023</Annotation>
        {' '}— ML-curated content feeds at 500px, LLM-integrated decision tools for enterprise operators. The industries keep changing. The craft doesn't.
      </p>
      <p className="body-text" style={{ marginBottom: '32px' }}>
        I'm outcome-driven, not output-driven. Code is cheaper than ever. What you choose to build is the whole game. I do my best work on small teams with clear ownership, leadership that's still close to the work, and a bias toward shipping.
      </p>
      <p className="body-text" style={{ fontFamily: "'Sanchez', serif", fontSize: '20px', lineHeight: 1.5, paddingLeft: '24px', borderLeft: '3px solid #ff9900' }}>
        The point isn't shipping. It's making someone's day less painful — for the user, and for the team building it.
      </p>
    </div>
  </FadeSection>
);
