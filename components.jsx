    ...
    <div style={{ maxWidth: '640px', margin: '0 auto' }}>
      ...
      <div className="project-card">
        ...
        <p className="body-text" style={{ marginBottom: '20px' }}>
          A work-in-progress experiment: an AI that connects to the tools a team already uses — meetings, Slack, planning docs — through their existing authentication and permissions, and distills those conversations into a clear, structured record of what the team is trying to achieve and why. No new data silo. When day-to-day decisions start drifting from that intent, Helm flags it.
        </p>
